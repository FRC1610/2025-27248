...
public class Constants {
    ...
    /// COLOR SENSOR
    public static final double COLOR_SENSOR_PURPLE_RATIO = 1.50; // Blue must exceed red and green by this factor
    ...
    // Tuned against field samples (purple B:G ≈ 1.55, green G:B ≈ 1.2 and G:R ≈ 2.4)
