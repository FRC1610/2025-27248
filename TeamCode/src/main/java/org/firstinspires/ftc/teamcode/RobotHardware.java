...
public class RobotHardware {
    ...
    public void init()    {
        ...
        launcherGroup = new LauncherMotorGroup(launcher, launcher2, myOpMode.telemetry, panelsTelemetry);
    ...
    public void setTargetRPM(double rpm) {
        ...
        if (flywheelOn) {
            ...
            launcherGroup.setVelocity(ticksPerSecond);
        } else {
            launcherGroup.setVelocity(0);
        }
    }
    ...
    public double getCurrentRPM() {
        ...
        return (launcherGroup.getVelocity() * 60.0) / (TICKS_PER_REV * Constants.LAUNCHER_GEAR_REDUCTION);
    }
